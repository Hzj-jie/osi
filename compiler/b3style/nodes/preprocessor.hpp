...
#include "../../bstyle/nodes/preprocessor.hpp"
#include "../../b2style/nodes/preprocessor.hpp"
        ...
        namespace b3style_compiler
        {
            ...
            struct b3style_folders
            {
                ...
                std::vector<std::string> operator()() const
                {
                    ...
                    r.push_back(b2style_compiler::b2style_inc_folder());
                    r.push_back(bstyle_compiler::bstyle_inc_folder());
            ...
            class include_with_string_node : public include_with_string<logic_writer, b3style_should_include, b3style_folders>
            {
            public:
            ...
            class include_with_file_node : public include_with_file<logic_writer, b3style_should_include, b3style_folders>
            {
            public:
